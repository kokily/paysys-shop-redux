...
const AllWide: React.FC<AllProps> = ({
  husband,
  bride,
  husbandRental,
  brideRental,
        ...
        <table>
          <tbody>
            ...
            <tr>
              ...
              <th>식대 분할</th>
              <td colSpan={3} className="sub" style={{ textAlign: 'center' }}>
                {(function () {
                  if (meal === 'privacy') {
                    return '각각 결제';
            ...
            <tr>
              ...
              <td>
                {brideCeremony.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                원
              </td>
              <td className="sub">
            ...
            <tr>
              ...
              <th>예약금 분할</th>
              <td colSpan={4} className="sub" style={{ textAlign: 'center' }}>
                {(function () {
                  if (reserve === 'half') {
                    return '예약금 반반';
