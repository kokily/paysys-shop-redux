...
const EditWide: React.FC<EditWideProps> = ({
  husband,
  bride,
  reservePay,
  husbandRental,
      ...
      <>
        <Content>
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  {brideMeal.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                </td>
                <td>
          ...
          <ButtonPane>
            ...
            <Button menu onClick={onCalculate}>
              다시계산
            </Button>
            <Button patch onClick={onSubmit}>
              저장하기
            </Button>
          </ButtonPane>
        </Content>
